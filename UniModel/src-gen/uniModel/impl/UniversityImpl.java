 ...
 * </p>
 * <ul>
 *   <li>{@link uniModel.impl.UniversityImpl#getName <em>Name</em>}</li>
 *   <li>{@link uniModel.impl.UniversityImpl#getFaculties <em>Faculties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
	...
	protected EClass eStaticClass() {
		return UniModelPackage.Literals.UNIVERSITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniModelPackage.UNIVERSITY__NAME, oldName, name));
	}
	...
	public EList<Faculty> getFaculties() {
		if (faculties == null) {
			faculties = new EObjectResolvingEList<Faculty>(Faculty.class, this, UniModelPackage.UNIVERSITY__FACULTIES);
		}
		return faculties;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UniModelPackage.UNIVERSITY__NAME:
			return getName();
		case UniModelPackage.UNIVERSITY__FACULTIES:
			return getFaculties();
		}
