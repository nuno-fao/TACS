 ...
 * </p>
 * <ul>
 *   <li>{@link uniModel.impl.ProfessorImpl#getName <em>Name</em>}</li>
 *   <li>{@link uniModel.impl.ProfessorImpl#getBirthdate <em>Birthdate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfessorImpl extends MinimalEObjectImpl.Container implements Professor {
	...
	protected EClass eStaticClass() {
		return UniModelPackage.Literals.PROFESSOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniModelPackage.PROFESSOR__NAME, oldName, name));
	}
	...
	public void setBirthdate(Date newBirthdate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniModelPackage.PROFESSOR__BIRTHDATE, oldBirthdate,
					birthdate));
	}
