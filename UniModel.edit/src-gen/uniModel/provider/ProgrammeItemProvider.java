...
/**
 * This is the item provider adapter for a {@link uniModel.Programme} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgrammeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Programme_name_feature",
								"_UI_Programme_type"),
						UniModelPackage.Literals.PROGRAMME__NAME, true, false, false,
	...
	protected void addCoursesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Programme_courses_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Programme_courses_feature",
								"_UI_Programme_type"),
						UniModelPackage.Literals.PROGRAMME__COURSES, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case UniModelPackage.PROGRAMME__NAME:
