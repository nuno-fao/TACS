...
/**
 * This is the item provider adapter for a {@link uniModel.Professor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfessorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Professor_name_feature",
								"_UI_Professor_type"),
						UniModelPackage.Literals.PROFESSOR__NAME, true, false, false,
	...
	protected void addBirthdatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Professor_birthdate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Professor_birthdate_feature",
								"_UI_Professor_type"),
						UniModelPackage.Literals.PROFESSOR__BIRTHDATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case UniModelPackage.PROFESSOR__NAME:
		case UniModelPackage.PROFESSOR__BIRTHDATE:
